...
[POST `_changes` API](https://github.com/IBM/cloudant-python-sdk/tree/v0.11.1/examples#postchanges) instead of the follower.
...
In these use-cases use the SDK's [POST `_changes` API](https://github.com/IBM/cloudant-python-sdk/tree/v0.11.1/examples#postchanges)
