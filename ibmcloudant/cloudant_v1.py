...
class CloudantV1(BaseService):
    ...
    def post_partition_explain_as_stream(
        self,
        db: str,
        partition_key: str,
        selector: dict,
        ...
        **kwargs,
        ...
        sdk_headers = get_sdk_headers(
            service_name=self.DEFAULT_SERVICE_NAME,
            service_version='V1',
            operation_id='post_partition_explain_as_stream',
        )
        headers.update(sdk_headers)
...
class PostExplainEnums:
    """
    Enums for post_explain parameters.
    """
...
class ExplainResultMrArgs:
    ...
    :attr bool include_docs: (optional) A parameter that specifies whether to
          ...
          view.
    :attr bool partition: (optional) Partition parameter passed to the underlying
          view.
    ...
    def __init__(
        ...
        *,
        ...
        :param bool include_docs: (optional) A parameter that specifies whether to
               include the full content of the documents in the response in the underlying
               view.
        :param bool partition: (optional) Partition parameter passed to the
               underlying view.
...
class ExplainResultOpts:
    ...
    :attr object fields: Schema for any JSON type.
    ...
    :attr List[int] r: The read quorum that is needed for the result.
    ...
    def __init__(
        ...
        :param bool execution_stats: Execution statistics used in the request
               query.
        :param object fields: Schema for any JSON type.
        ...
        :param List[int] r: The read quorum that is needed for the result.
...
class ReplicationDocument:
    ...
    :attr ReplicationDatabase source: Schema for a replication source or target
          database.
    :attr str source_proxy: (optional) This setting is forbidden in IBM Cloudant
          replication documents. This setting may be used with alternative replication
          mediators.
    ...
    :attr ReplicationDatabase target: Schema for a replication source or target
          database.
    :attr str target_proxy: (optional) This setting is forbidden in IBM Cloudant
          replication documents. This setting may be used with alternative replication
          mediators.
          Address of a (http or socks5 protocol) proxy server through which replication
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param str source_proxy: (optional) This setting is forbidden in IBM
        ...
        :param str target_proxy: (optional) This setting is forbidden in IBM
               Cloudant replication documents. This setting may be used with alternative
               replication mediators.
               Address of a (http or socks5 protocol) proxy server through which
